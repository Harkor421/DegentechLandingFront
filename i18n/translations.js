export const translations = {
  en: {
    ...
    process: {
      ...
      heading: 'Our Process',
      steps: [
        { number: '01', title: 'Discover', desc: 'Scope, research & strategic planning' },
        { number: '02', title: 'Design', desc: 'Architecture, UX & prototyping' },
        { number: '03', title: 'Build', desc: 'Iterative development & testing' },
        { number: '04', title: 'Launch', desc: 'Deploy, optimize & support' },
      ],
    },
    difference: {
      label: 'Why Us',
    ...
    testimonials: {
      ...
      items: [
        {
          quote:
            'DegenTech delivered a production system in 8 weeks that our previous vendor couldn\'t build in 6 months. No fluff, just results.',
          name: 'Marcus Chen',
          role: 'CTO',
    ...
    contact: {
      ...
      subtitle: 'Tell us about your project. We get back to you within 24 hours.',
      cta: 'Start a Project',
    },
    footer: {
  ...
  es: {
    ...
    projects: {
      ...
      items: [
        {
          title: 'Panel de Fábrica Inteligente',
          tag: 'SaaS',
          description:
