            ...
            {t.difference.items.map((item, i) => (
              ...
              >
                <div className="flex items-start sm:items-center gap-2 sm:gap-3">
                  <svg className="w-4 h-4 text-red-400/60 shrink-0 mt-0.5 sm:mt-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="flex items-start sm:items-center gap-2 sm:gap-3">
                  <svg className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5 sm:mt-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
