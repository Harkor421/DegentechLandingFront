...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="max-w-[1200px] mx-auto px-6 md:px-8 flex items-center justify-between h-16">
        <a
          href="#"
      ...
      {mobileOpen && (
        <div className="sm:hidden bg-primary/98 backdrop-blur-xl border-t border-white/[0.06] px-6 py-6 flex flex-col gap-4">
          ...
          <a
            href="#contact"
            onClick={() => setMobileOpen(false)}
            className="btn-primary text-sm font-medium px-4 py-2.5 rounded-lg text-center mt-2"
          >
            {t.nav.contact}
          </a>
        </div>
